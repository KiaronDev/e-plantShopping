...
const CartItem = ({ onContinueShopping }) => {
  ...
  const calculateTotalCost = (item) => {
    return (parseFloat(item.cost.substring(1)) * item.quantity).toFixed(2); // calculate and format
  };
        ...
        {cart.map(item => (
          <div className="cart-item" key={item.name}>
            ...
            <div className="cart-item-details">
              ...
              <div className="cart-item-cost">${item.cost.substring(1)}</div> {/* Strip "$" for formatting */}
